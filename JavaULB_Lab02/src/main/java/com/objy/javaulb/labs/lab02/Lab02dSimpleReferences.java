 ...
 * @author Daniel
 */
public class Lab02dSimpleReferences {

    private static Logger logger = LoggerFactory.getLogger(Lab02dSimpleReferences.class);
