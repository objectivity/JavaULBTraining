 ...
 * @author Daniel
 */
public class Lab02eBidirRefToOneToOne {

    private static Logger logger = LoggerFactory.getLogger(Lab02eBidirRefToOneToOne.class);
    ...
    public Lab02eBidirRefToOneToOne() {
