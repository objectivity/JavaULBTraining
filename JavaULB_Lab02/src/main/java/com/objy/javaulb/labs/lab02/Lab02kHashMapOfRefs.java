 ...
 * @author Daniel
 */
public class Lab02kHashMapOfRefs {

    private static Logger logger = LoggerFactory.getLogger(Lab02kHashMapOfRefs.class);
            ...
            try (TransactionScope tx = new TransactionScope(TransactionMode.READ_UPDATE)) {
                ...
                cBuilderAddress.addAttribute("LivesHere",
                        new MapSpecificationBuilder()
                                .setCollectionName("HashMapOfReferences")
                                .setKeySpecification(
