 ...
 * @author Daniel
 */
public class Lab02gBiDirRefToManyToOne {

    private static Logger logger = LoggerFactory.getLogger(Lab02gBiDirRefToManyToOne.class);
    ...
    public Lab02gBiDirRefToManyToOne() {
