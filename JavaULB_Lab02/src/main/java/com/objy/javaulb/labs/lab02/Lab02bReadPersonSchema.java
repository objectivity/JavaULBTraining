 ...
 * @author Daniel
 */
public class Lab02bReadPersonSchema {

    private static Logger logger = LoggerFactory.getLogger(Lab02bReadPersonSchema.class);
