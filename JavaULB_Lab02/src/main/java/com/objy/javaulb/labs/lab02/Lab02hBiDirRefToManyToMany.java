 ...
 * @author Daniel
 */
public class Lab02hBiDirRefToManyToMany {

    private static Logger logger = LoggerFactory.getLogger(Lab02hBiDirRefToManyToMany.class);
    ...
    public Lab02hBiDirRefToManyToMany() {
    ...
    public static void main(String[] args) {
        new Lab02hBiDirRefToManyToMany();
    }
}
