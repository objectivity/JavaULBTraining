 ...
 * @author Daniel
 */
public class Lab02jNameMapOfRefs {

    private static Logger logger = LoggerFactory.getLogger(Lab02jNameMapOfRefs.class);
            ...
            try (TransactionScope tx = new TransactionScope(TransactionMode.READ_UPDATE)) {
                ...
                cBuilderAddress.addAttribute("LivesHere",
                        new MapSpecificationBuilder()
                                .setCollectionName("NameToReferenceMap")  
                                .setKeySpecification(
                                    new StringSpecificationBuilder()
                                        .setEncoding(Encoding.String.BYTE)                                        
                                        .build()
                                    )
