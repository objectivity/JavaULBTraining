 ...
 * @author Daniel
 */
public class Lab02lTreeMapOfRefs {

    private static Logger logger = LoggerFactory.getLogger(Lab02lTreeMapOfRefs.class);
            ...
            try (TransactionScope tx = new TransactionScope(TransactionMode.READ_UPDATE)) {
                ...
                cBuilderAddress.addAttribute("LivesHere",
                        new MapSpecificationBuilder()
                                .setCollectionName("TreeMapOfReferences")
                                .setKeySpecification(
