 ...
 * @author Daniel
 */
public class Lab02aCreatePersonClass {

    private static Logger logger = LoggerFactory.getLogger(Lab02aCreatePersonClass.class);
    ...
    public Lab02aCreatePersonClass() {
