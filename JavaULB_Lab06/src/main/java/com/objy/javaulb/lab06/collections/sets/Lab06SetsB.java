 ...
 * @author Daniel
 */
public class Lab06SetsB {

    private static Logger logger = LoggerFactory.getLogger(Lab06SetsB.class);
    ...
    private ArrayList<String> pnOIDS = new ArrayList<>();
            ...
            try (TransactionScope tx = new TransactionScope(TransactionMode.READ_UPDATE)) {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        Iterator<Variable> setIt = pnSet.elements().iterator();
                        int i = 0;
                        while(setIt.hasNext()) {
